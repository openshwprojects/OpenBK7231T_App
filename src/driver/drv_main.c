...
static driver_t g_drivers[] = {
	...
	//drvdetail:"descr":"TuyaMCU is a protocol used for communication between WiFI module and external MCU. This protocol is using usually RX1/TX1 port of BK chips.",
	//drvdetail:"requires":""}
