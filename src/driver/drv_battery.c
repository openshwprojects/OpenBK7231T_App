...
static int g_pin_adc = 0, channel_adc = 0, channel_rel = 0, g_pin_rel = 0, g_battcycle = 1, g_battcycleref = 30;
...
void Batt_Init() {
	...
	//cmddetail:"descr":"change cycle of measurement by default every 30 seconds",
