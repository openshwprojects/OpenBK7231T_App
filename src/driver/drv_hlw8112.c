...
void HLW8112_AppendInformationToHTTPIndexPage(http_request_t *request, int bPreState) {
	...
	appendTableRow(request, "KU", "", device.ResistorCoeff.KU, 4, 1 );
	appendTableRow(request, "KIA", "", device.ResistorCoeff.KIA, 4, 1 );
	appendTableRow(request, "KIB", "", device.ResistorCoeff.KIB, 4, 1 );
