...
/* Drop-in smaller-digit replacement of the original g_font[].
 *
 * This defines `byte g_font_small[]` with the same overall layout as the
 * original `g_font[]` found in drv_max72xx_single.c, but replaces the
 * glyphs for ASCII '0'..'9' (48..57) with 4-column-wide versions.
 *
 * Format:
 *   [width], col0, col1, ..., colN   // for each character in ascending code order
 * terminated by a final 255 sentinel byte.
 *
 * Use this array as a direct replacement for g_font[] (rename or copy into
 * the original source). The rest of the glyphs are unchanged from the
 * original file you provided, only the digit widths/columns are reduced
 * to at most 4 columns.
 */
...
byte g_font[] =
{
	...
	2, 96, 96,                // 46 - .
	5, 32, 16, 8, 4, 2,       // 47 - /
	4, 127, 65, 65, 127,      // 48 - 0  (4-column small)
	4, 0, 66, 127, 64,        // 49 - 1  (4-column small)
	4, 121, 73, 73, 79,       // 50 - 2  (4-column small)
	4, 65, 73, 73, 127,       // 51 - 3  (4-column small)
	4, 12, 10, 127, 8,        // 52 - 4  (4-column small)
	4, 79, 73, 73, 121,       // 53 - 5  (4-column small)
	4, 127, 73, 73, 121,      // 54 - 6  (4-column small)
	4, 1, 121, 5, 3,          // 55 - 7  (4-column small)
	4, 127, 73, 73, 127,      // 56 - 8  (4-column small)
	4, 79, 73, 73, 127,       // 57 - 9  (4-column small)
	1, 20,                    // 58 - :
	2, 128, 104,              // 59 - ;
	4, 8, 20, 34, 65,         // 60 - <
	5, 20, 20, 20, 20, 20,    // 61 - =
	...
	0,                        // 127 - Unused
	6, 20, 62, 85, 85, 65, 34,// 128 - Euro sign
	1, 0,                     // 129 - one single empty "line" - was: Not used
	2, 128, 96,               // 130 - Single low 9 quotation mark
	5, 192, 136, 126, 9, 3,   // 131 - f with hook
	4, 128, 96, 128, 96,      // 132 - Single low 9 quotation mark
	8, 96, 96, 0, 96, 96, 0, 96, 96,   // 133 - Horizontal ellipsis
