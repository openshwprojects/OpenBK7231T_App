...
void http_html_end(http_request_t* request) {
	...
	hprintf255(request, "<br>Device time:&nbsp;<span id=\"DT\" data-initial=\"%u\">-</span>",Clock_IsTimeSynced()? Clock_GetCurrentTimeWithoutOffset()-g_secondsElapsed : 1);
#endif
