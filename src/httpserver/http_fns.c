...
#if ENABLE_INCLUDE_BUILD_DEFINES
	#include "../platformdefines.h"
	poststr(request, "<details><summary>Defined \"ENABLE_\" for this build</summary>");
	poststr(request, platformdefines);
	poststr(request, "</details><p>");
#endif
