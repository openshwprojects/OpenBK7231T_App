...
void Test_TuyaMCU_Robustness() {
	...
	//
	// Malformed packet: 55AA03070007010200040000172E
	...
	CMD_ExecuteCommand("uartFakeHex 55AA03070007010200040000172E", 0);
	Sim_RunFrames(100, false);
	...
	//
	// Malformed packet: 55AA000500070102000400001224
	...
	CMD_ExecuteCommand("uartFakeHex 55AA000500070102000400001224", 0);
	Sim_RunFrames(100, false);
	...
	//
	// Malformed packet: 55AA0008000E000000000000000102000400001C38
	...
	CMD_ExecuteCommand("uartFakeHex 55AA0008000E000000000000000102000400001C38", 0);
	Sim_RunFrames(100, false);
