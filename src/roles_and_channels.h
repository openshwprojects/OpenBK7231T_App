...
typedef enum {
	CHAN_Empty,			// 0 = no Description
	CHAN_Connector,		// 1 = Connector (LED, button, relay ...)
	CHAN_Temperature,	// 2 = Temperature
	CHAN_Humidity,		// 3 = Humidity
	CHAN_Input,			// 4 = Input pin value
	CHAN_Toggle,		// 5 = Channel for toggle
	CHAN_CO2,			// 6 = Channel or CO2 value
	CHAN_TVOC,			// 7 = Channel TVOC value
	CHAN_Func1,			// 8 = Room for additional functions
	CHAN_Func2,			// 9 = Room for additional functions
	CHAN_Func3			// 10 = Room for additional functions
} chanval_t ;
...
short chanvals[] = {
	...
	INFO2CHANVAL(IOR_Relay, 1, CHAN_Connector, CHAN_Empty),
	INFO2CHANVAL(IOR_Relay_n, 1, CHAN_Connector, CHAN_Empty),
	INFO2CHANVAL(IOR_Button, 2, CHAN_Connector, CHAN_Connector),
	INFO2CHANVAL(IOR_Button_n, 2, CHAN_Connector, CHAN_Connector),
	INFO2CHANVAL(IOR_LED, 1, CHAN_Connector, CHAN_Empty),
	INFO2CHANVAL(IOR_LED_n, 1, CHAN_Connector, CHAN_Empty),
	...
	INFO2CHANVAL(IOR_DigitalInput, 1, CHAN_Input, CHAN_Empty),
	INFO2CHANVAL(IOR_DigitalInput_n, 1, CHAN_Input, CHAN_Empty),
	INFO2CHANVAL(IOR_ToggleChannelOnToggle, 1, CHAN_Toggle, CHAN_Empty),
	INFO2CHANVAL(IOR_DigitalInput_NoPup, 1, CHAN_Input, CHAN_Empty),
	INFO2CHANVAL(IOR_DigitalInput_NoPup_n, 1, CHAN_Input, CHAN_Empty),
	...
	INFO2CHANVAL(IOR_ADC, 1, CHAN_Input, CHAN_Empty),
	...
	INFO2CHANVAL(IOR_DHT11, 2, CHAN_Temperature, CHAN_Humidity),
	INFO2CHANVAL(IOR_DHT12, 2, CHAN_Temperature, CHAN_Humidity),
	INFO2CHANVAL(IOR_DHT21, 2, CHAN_Temperature, CHAN_Humidity),
	INFO2CHANVAL(IOR_DHT22, 2, CHAN_Temperature, CHAN_Humidity),
	INFO2CHANVAL(IOR_CHT83XX_DAT, 2, CHAN_Temperature, CHAN_Humidity),
	INFO2CHANVAL(IOR_CHT83XX_CLK, 0, CHAN_Empty, CHAN_Empty),
	INFO2CHANVAL(IOR_SHT3X_DAT, 2, CHAN_Temperature, CHAN_Humidity),
	...
	INFO2CHANVAL(IOR_SmartButtonForLEDs, 1, CHAN_Toggle, CHAN_Empty),
	INFO2CHANVAL(IOR_SmartButtonForLEDs_n, 1, CHAN_Temperature, CHAN_Empty),
	INFO2CHANVAL(IOR_DoorSensorWithDeepSleep, 1, CHAN_Input, CHAN_Empty),
	INFO2CHANVAL(IOR_DoorSensorWithDeepSleep_NoPup, 1, CHAN_Input, CHAN_Empty),
	INFO2CHANVAL(IOR_BAT_ADC, 1, CHAN_Empty, CHAN_Empty),
	INFO2CHANVAL(IOR_BAT_Relay, 1, CHAN_Connector, CHAN_Empty),
	...
	INFO2CHANVAL(IOR_ADC_Button, 1, CHAN_Connector, CHAN_Empty),
	...
	INFO2CHANVAL(IOR_DS1820_IO, 1, CHAN_Temperature, CHAN_Empty),
	INFO2CHANVAL(IOR_PWM_ScriptOnly, 1, CHAN_Empty, CHAN_Empty),
	INFO2CHANVAL(IOR_PWM_ScriptOnly_n, 1, CHAN_Empty, CHAN_Empty),
	INFO2CHANVAL(IOR_Counter_f, 1, CHAN_Input, CHAN_Empty),
	INFO2CHANVAL(IOR_Counter_r, 1, CHAN_Input, CHAN_Empty),
