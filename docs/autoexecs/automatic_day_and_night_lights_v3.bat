...
setChannelLabel 10  "<b><span style='color:orange'\>Sunset</span></b>"
...
// set the next sunset value (with an additional 30mins to have a rough civil sunset time)
alias calc_sunset backlog setChannel 10 $sunset*60 + 1800; removeClockEvent 4; addClockEvent $CH10 0xff 4 high_lights

addClockEvent 3:00 0xff 1 calc_sunset
