...
# Basic doc pages 
- [Safe mode](https://github.com/openshwprojects/OpenBK7231T_App/blob/main/docs/safeMode.md)
- [Simple TCP command server for scripting](https://github.com/openshwprojects/OpenBK7231T_App/blob/main/docs/tcpServer.md)
- [HomeAssistant Integration](https://github.com/openshwprojects/OpenBK7231T_App/blob/main/docs/homeAssistant.md)

# Doc tables 
| Section        | Comment        |
|:------------- |------:|
| [IO/Pin Roles](https://github.com/openshwprojects/OpenBK7231T_App/blob/main/docs/ioRoles.md) (66 total) | You can set pin roles in 'Configure Module' section or use one of predefined templates in Web App. For each pin, you also set coresponding channel value. This is needed for modules with multiple relays. If you have 3 relays and 3 buttons, you need to use channel values like 1, 2, and 3. Just enter '1' in the text field, etc. |
