...
| VCPPrecision | [VoltageDigits][CurrentDigitsAmpers][PowerDigitsWats][PowerDigitsWh] | Sets the number of digits after decimal point for power metering publishes. Default is BL09XX_VCPPrecision 1 3 2 3. |
