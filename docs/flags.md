...
| 51 | [WiFi] (RTL/BK) Enhanced fast connect by saving AP data to flash (preferable with Flag 37 & static ip).|
| 52 | [GirerMCU] Use queue"|
Quick reset 3 times to connect normally |
