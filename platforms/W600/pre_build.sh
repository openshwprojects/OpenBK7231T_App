...
LWIPOPTS="sdk/OpenW600/src/network/lwip2.0.3/include/lwip/lwipopts.h"

if [ -f "$LWIPOPTS" ]; then
	echo "PREBUILD W600: enabling lwIP mDNS options"
	...
	echo "PREBUILD W600: WARN lwipopts.h not found: $LWIPOPTS"
fi
