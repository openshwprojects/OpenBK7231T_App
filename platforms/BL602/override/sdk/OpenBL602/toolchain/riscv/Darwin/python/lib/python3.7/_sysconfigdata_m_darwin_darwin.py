...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/scratch/carsteng/git/py3/install3/bin',
 'BINLIBDEST': '/scratch/carsteng/git/py3/install3/lib/python3.7',
 ...
 'CONFIG_ARGS': "'--prefix=/scratch/carsteng/git/py3/install3' "
                "'--disable-shared'",
 'CONFINCLUDEDIR': '/scratch/carsteng/git/py3/install3/include',
 'CONFINCLUDEPY': '/scratch/carsteng/git/py3/install3/include/python3.7m',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/scratch/carsteng/git/py3/Python-3.7.7/coverage.info',
 'COVERAGE_REPORT': '/scratch/carsteng/git/py3/Python-3.7.7/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++',
 'DESTDIRS': '/scratch/carsteng/git/py3/install3 '
             '/scratch/carsteng/git/py3/install3/lib '
             '/scratch/carsteng/git/py3/install3/lib/python3.7 '
             '/scratch/carsteng/git/py3/install3/lib/python3.7/lib-dynload',
 'DESTLIB': '/scratch/carsteng/git/py3/install3/lib/python3.7',
 'DESTPATH': '',
 'DESTSHARED': '/scratch/carsteng/git/py3/install3/lib/python3.7/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/scratch/carsteng/git/py3/install3/include '
                   '/scratch/carsteng/git/py3/install3/include '
                   '/scratch/carsteng/git/py3/install3/include/python3.7m '
                   '/scratch/carsteng/git/py3/install3/include/python3.7m',
 'INCLUDEDIR': '/scratch/carsteng/git/py3/install3/include',
 'INCLUDEPY': '/scratch/carsteng/git/py3/install3/include/python3.7m',
 ...
 'LDVERSION': '3.7m',
 'LIBC': '',
 'LIBDEST': '/scratch/carsteng/git/py3/install3/lib/python3.7',
 'LIBDIR': '/scratch/carsteng/git/py3/install3/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/scratch/carsteng/git/py3/install3/lib/pkgconfig',
 'LIBPL': '/scratch/carsteng/git/py3/install3/lib/python3.7/config-3.7m-darwin',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/scratch/carsteng/git/py3/install3/lib/python3.7',
 'MACOSX_DEPLOYMENT_TARGET': '10.14',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/scratch/carsteng/git/py3/install3/share/man',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/scratch/carsteng/git/py3/install3/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'abs_builddir': '/scratch/carsteng/git/py3/Python-3.7.7',
 'abs_srcdir': '/scratch/carsteng/git/py3/Python-3.7.7',
 'datarootdir': '/scratch/carsteng/git/py3/install3/share',
 'exec_prefix': '/scratch/carsteng/git/py3/install3',
 'prefix': '/scratch/carsteng/git/py3/install3',
 'srcdir': '.'}
