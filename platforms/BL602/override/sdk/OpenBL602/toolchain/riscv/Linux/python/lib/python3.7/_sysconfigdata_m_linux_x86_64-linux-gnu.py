...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/scratch/carsteng/git/py3/install/bin',
 'BINLIBDEST': '/scratch/carsteng/git/py3/install/lib/python3.7',
 ...
 'CONFIG_ARGS': "'--prefix=/scratch/carsteng/git/py3/install' "
                "'--disable-shared'",
 'CONFINCLUDEDIR': '/scratch/carsteng/git/py3/install/include',
 'CONFINCLUDEPY': '/scratch/carsteng/git/py3/install/include/python3.7m',
 'COREPYTHONPATH': '',
 ...
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/scratch/carsteng/git/py3/install '
             '/scratch/carsteng/git/py3/install/lib '
             '/scratch/carsteng/git/py3/install/lib/python3.7 '
             '/scratch/carsteng/git/py3/install/lib/python3.7/lib-dynload',
 'DESTLIB': '/scratch/carsteng/git/py3/install/lib/python3.7',
 'DESTPATH': '',
 'DESTSHARED': '/scratch/carsteng/git/py3/install/lib/python3.7/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/scratch/carsteng/git/py3/install/include '
                   '/scratch/carsteng/git/py3/install/include '
                   '/scratch/carsteng/git/py3/install/include/python3.7m '
                   '/scratch/carsteng/git/py3/install/include/python3.7m',
 'INCLUDEDIR': '/scratch/carsteng/git/py3/install/include',
 'INCLUDEPY': '/scratch/carsteng/git/py3/install/include/python3.7m',
 ...
 'LDVERSION': '3.7m',
 'LIBC': '',
 'LIBDEST': '/scratch/carsteng/git/py3/install/lib/python3.7',
 'LIBDIR': '/scratch/carsteng/git/py3/install/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/scratch/carsteng/git/py3/install/lib/pkgconfig',
 'LIBPL': '/scratch/carsteng/git/py3/install/lib/python3.7/config-3.7m-x86_64-linux-gnu',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/scratch/carsteng/git/py3/install/lib/python3.7',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/scratch/carsteng/git/py3/install/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/scratch/carsteng/git/py3/install/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'datarootdir': '/scratch/carsteng/git/py3/install/share',
 'exec_prefix': '/scratch/carsteng/git/py3/install',
 'prefix': '/scratch/carsteng/git/py3/install',
 'srcdir': '.'}
