...
struct bt_mesh_prov {
     ...
     */
    void (*unprovisioned_beacon)(const bt_addr_le_t *addr, u8_t uuid[16],
                                 bt_mesh_prov_oob_info_t oob_info,
                                 u32_t *uri_hash);
     ...
     *
     *  @param bearer Provisioning bearer.
     *  @param prov_success means the provision process finished or failed
     */
    void (*link_close)(bt_mesh_prov_bearer_t bearer, bool prov_success);
...
u8_t bt_mesh_dist_map_get(u16_t dst);
