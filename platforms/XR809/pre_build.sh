# This script will be called just before starting build process for OpenXR809
...
#IFS='
#'
#for X in $(find platforms/OpenXR809/override/ -type f);do
...
#	# starting with "sdk/OpenOpenXR809/..."
#	D=${X#platforms/OpenXR809/override/};
...
# sed -i "s/#define FOO bar/#define FOO baz/" sdk/OpenOpenXR809/project/OpenBeken/cfg/file_to_change.h
# or, let's assume you made a local change to your SDK
# and make a diff from that change (inside sdk/OpenOpenXR809/)
# git diff > ../../platforms/OpenXR809/my_change.diff
# ( or make the diff and copy this file to platforms/OpenXR809)
#
# and then in pre_build.sh you apply this patch with:
#
# patch -p 1 -d sdk/OpenOpenXR809 < platforms/OpenXR809/my_change.diff
...
sed -i "s%\(^[ \t]*SUBDIRS +=\) driver/component%\1%" sdk/OpenXR809/src/Makefile
sed -i "s%-lcomponent%%" sdk/OpenXR809/project/project.mk
