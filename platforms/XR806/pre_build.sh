# This script will be called just before starting build process for OpenXR806
...
#IFS='
#'
#for X in $(find platforms/OpenXR806/override/ -type f);do
...
#	# starting with "sdk/OpenOpenXR806/..."
#	D=${X#platforms/OpenXR806/override/};
...
# sed -i "s/#define FOO bar/#define FOO baz/" sdk/OpenOpenXR806/project/OpenBeken/cfg/file_to_change.h
# or, let's assume you made a local change to your SDK
# and make a diff from that change (inside sdk/OpenOpenXR806/)
# git diff > ../../platforms/OpenXR806/my_change.diff
# ( or make the diff and copy this file to platforms/OpenXR806)
#
# and then in pre_build.sh you apply this patch with:
#
# patch -p 1 -d sdk/OpenOpenXR806 < platforms/OpenXR806/my_change.diff
...
sed -i "s%^[ \t]*SUBDIRS += driver/component%//&%" sdk/OpenXR806/src/Makefile
sed -i "/LIBRARIES += -lcomponent/ d" sdk/OpenXR806/project/project.mk
