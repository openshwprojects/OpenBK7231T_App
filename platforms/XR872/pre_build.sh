# This script will be called just before starting build process for XR872
...
#IFS='
#'
#for X in $(find platforms/XR872/override/ -type f);do
...
#	# starting with "sdk/OpenXR872/..."
#	D=${X#platforms/XR872/override/};
