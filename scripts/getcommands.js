...
function writeDocMD(name, content, json, label) {
...
writeDocMD('channelTypes', channelsmdshort, channels, "Channel Types");
writeDocMD('ioRoles', iosmdshort, ios, "IO/Pin Roles");
writeDocMD('commands', mdshort, commands, "Console/Script commands");
writeDocMD('flags', flagsmdshort, flags, "Flags");
writeDocMD('constants', constantsmdshort, cnsts, "Script constants");
writeDocMD('drivers', driversmdshort, drvs, "Drivers");
writeDocMD('commands-extended', mdlong, commands, "Console/Script commands [Extended Edition]");
