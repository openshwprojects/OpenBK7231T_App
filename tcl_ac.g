...
uint8_t set_cmd_base[35] = { 0xBB, 0x00, 0x01, 0x03, 0x1D, 0x00, 0x00, 0x64, 0x03, 0xF3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,[...]
...
/* Added Gen options for Home Assistant discovery.  Adjust number of elements if needed. */
...
void TCL_Init(void) {
	...
	//cmndetail:"descr":"",
	//cmndetail:"fn":"CMD_ACMode","file":"driver/drv_tclAC.c","requires":"",
	//cmndetail:"examples":""}
...
void TCL_DoDiscovery(const char *topic) {
	...
	/* Create Gen select entity so Home Assistant discovery exposes the Gen setting.
	   Uses the Gen command topic: cmnd/<clientid>/Gen
	   State topic: ~/Gen/get
	*/
	{
